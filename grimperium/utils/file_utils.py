...
def ensure_directory_exists(
    directory_path: str, logger: Optional[logging.Logger] = None
) -> bool:
    """
...
def validate_file_exists(
    file_path: str, must_be_readable: bool = True, min_size_bytes: int = 0
) -> Tuple[bool, str]:
    """
...
def validate_file_format(
    file_path: str, expected_formats: Optional[List[str]] = None
) -> Tuple[bool, str]:
    """
...
def get_unique_output_path(base_path: str, extension: Optional[str] = None) -> str:
    """
...
def cleanup_temp_files(
    file_paths: List[str], logger: Optional[logging.Logger] = None
) -> int:
    """
