...
def check_executable_available(executable_name: str, 
...
def validate_executable_version(executable_name: str,
    ...
    if result.success:
        ...
        logger.warning(f"Could not get version for '{executable_name}': {result.stderr}")
        return None


def create_output_file_path(input_path: str, 
                          new_extension: str,
