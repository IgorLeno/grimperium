...
class BaseService(ABC):
    ...
    def validate_string_input(
        self, value: Any, param_name: str, allow_empty: bool = False
    ) -> Optional[str]:
        """
    ...
    def validate_path_input(
        self, path: Any, param_name: str, must_exist: bool = False
    ) -> str:
        """
        Validate path input.
    ...
    def handle_service_error(
        self, error: Exception, operation: str, return_value: Any = None
    ) -> Any:
        """
