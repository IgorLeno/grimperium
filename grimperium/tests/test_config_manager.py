...
class TestConfigManager:
    ...
    def test_load_config_valid_file(
        self, valid_config_file, valid_config_dict, tmp_path
    ):
...
class TestConfigManagerUtilities:
    ...
    def test_get_config_value_with_default(self):
        ...
        config = {"existing_key": "existing_value", "nested": {"key": "nested_value"}}
        ...
        try:
            ...
            value = config_manager.get_config_value(
                config, "missing_key", "default_value"
            )
    ...
    def test_expand_config_paths(self, tmp_path):
        ...
        config_with_paths = {
            "repository_base_path": "~/repository",
            "database": {"pm7_db_path": "./data/pm7.csv"},
        }
